...
export default {
  id: 'keno',
  name: 'KENO',
  tag: 'Pick your numbers, twenty balls drop',
  ...
  init(body) {
    body.innerHTML = '<div class="table"><div style="flex:1;display:grid;place-items:center;color:rgba(244,241,247,0.6)">The KENO table is being felted. Check back in a minute.</div></div>';
  },
};
