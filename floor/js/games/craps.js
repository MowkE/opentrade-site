...
export default {
  id: 'craps',
  name: 'CRAPS',
  tag: 'The loudest corner of any casino',
  ...
  init(body) {
    body.innerHTML = '<div class="table"><div style="flex:1;display:grid;place-items:center;color:rgba(244,241,247,0.6)">The CRAPS table is being felted. Check back in a minute.</div></div>';
  },
};
