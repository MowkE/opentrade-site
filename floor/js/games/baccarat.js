...
export default {
  id: 'baccarat',
  name: 'BACCARAT',
  tag: 'Player or banker, the cards decide',
  ...
  init(body) {
    body.innerHTML = '<div class="table"><div style="flex:1;display:grid;place-items:center;color:rgba(244,241,247,0.6)">The BACCARAT table is being felted. Check back in a minute.</div></div>';
  },
};
