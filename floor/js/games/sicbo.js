...
export default {
  id: 'sicbo',
  name: 'SIC BO',
  tag: 'Three dice, a hundred ways to sweat',
  ...
  init(body) {
    body.innerHTML = '<div class="table"><div style="flex:1;display:grid;place-items:center;color:rgba(244,241,247,0.6)">The SIC BO table is being felted. Check back in a minute.</div></div>';
  },
};
